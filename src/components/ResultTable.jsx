function ResultTable({ ideas, onSelectIdea }) {
  ...
  return (
    <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 overflow-hidden">
      <div className="px-4 lg:px-6 py-4 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border-b border-slate-700/50">
      ...
      <div className="lg:hidden p-4 space-y-4">
        {ideas.map((idea, index) => (
          <div
            key={index}
            className="bg-slate-700/30 rounded-xl p-4 border border-slate-700/50 hover:bg-slate-700/40 transition-colors cursor-pointer"
            onClick={() => onSelectIdea(idea)}
          >
